...
urlpatterns = [  # pk -> id
    ...
    # ---- MATERIA ----   
    path('materias/', MateriaList.as_view()),     
    path('materias/<int:pk>', MateriaDetails.as_view()),
    # ---- EJES ----   
    path('ejes/', EjeList.as_view()),
    path('ejes/<int:pk>', EjeDetails.as_view()),    
    # ---- PLANES ----   
    path('planes/', PlanList.as_view()),
    path('planes/<int:pk>', PlanDetails.as_view()),   
    # ---- PLANES - MATERIAS ----   
    path('planes/materias', PlanMateriaList.as_view()),
    path('planes/materias/<int:pk>', PlanMateriaDetails.as_view()),   
]
